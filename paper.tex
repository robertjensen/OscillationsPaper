...
\noindent \normalsize{High-quality mass spectrometry data of the oscillatory behaviour of CO oxidation on silicon dioxide supported Pt-nanoparticles at atmospheric pressure is presented. The oscillations are self-sustained for several days at constant temperature, pressure and CO/O$_2$ ratio. The frequency of the oscillations is very well defined and show clear tendency to increase in with time. A plausible mechanism for the oscillations is proposed based on an earlier model on Pd single crystals [Hendriksen \textit{et al., Nature Chemistry}, 2010, \textbf{9}, 730]}
\vspace{0.5cm}
 \end{@twocolumnfalse}
  ]
