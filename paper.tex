...
\end{figure}
The qualitative same behavior has been reproduced on a large number of samples. Nanoparticles with sizes ranging from 3\,nm to 9\,nm have been tested but 3\,nm particles with a geometrical coverage of 0.1\% of the reactor area gave the most stable oscillations. Higher coverages also showed oscillations but often only on the inital heating and cooling ramps. Only on rare occasions sustained oscillations were measured at constant temperature.
