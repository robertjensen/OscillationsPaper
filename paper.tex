...
\noindent\large{\textbf{Robert Jensen$^{\ast}$\textit{$^{a}$}, Thomas Andersen\textit{$^{b\ddag}$}, Anders Nierhoff\textit{$^{b\ddag}$}, Søren Dahl\textit{$^{b\ddag}$}, Ole Hansen\textit{$^{b\ddag}$} and Ib Chorkendorff\textit{$^{a}$}}}\vspace{0.5cm}
...
The measurents are done in a silicon-fabricated microreactor, developed here at CINF (REF!)....
