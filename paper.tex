...
!!!! Already the early theretical descriptions of the possibility of oscillationary beheaviour even very simple catalytic systems (eg \cite{LAGOS1979,IVANOV1980,TAKOUDIS1981,SONG1991}) noticed that even though oscillation can theoretically occur in many catalytic systems, the details are extremely specific to the given system, and it can thus be diffuctult to predict how and if a given system will oscillate. !!!!

!!! Oscillations in catalytic systems can be quite complex and the parameter space can be very large\cite{Ferino1999}. In the system investigated in this paper, oscillations could be dependant on morphologic parameres of the nanoparticels such as size, shape and exposed facets. Also the oxidation state and possible carbon pollution on the surface could have impact on the system. More macroscopic parameters such as the geometry of the reactor, the temperature distribution and the distribution of the particles throughout the reactor will influcence the systems ability to show kinetic oscillations. !!!
