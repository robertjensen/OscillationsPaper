...
axis.annotate('M28', xy=(80, 3.5),  xycoords='data', xytext=(120, 4.5), textcoords='data', arrowprops=arrow, horizontalalignment='right', verticalalignment='center',fontsize=9,)
axis.annotate('M44', xy=(80, 1.2),  xycoords='data', xytext=(120, 2.25), textcoords='data', arrowprops=arrow, horizontalalignment='right', verticalalignment='center',fontsize=9,)
